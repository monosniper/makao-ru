...
const PushMoney = () => {
    ...
    const contents = {
        'card': <CardPay2 amount={amount} setCurrent={setCurrent} submit={submitCard} />,
    ...
    return !payCompleted ? (
        <div>
            ...
            <div className="pushmoney-amount-group">
                ...
                <Input className='field' type='number' min="300" max="1000000" value={amount} onChange={setAmount} />
